...
func TestGetModifyHabitFunc(t *testing.T) {
	...
	tr := &transactionMock{}
	tr.Add(func () error {
		getModifyHabitFunc(h, "testHabit", "", "", "", "", false, false, false, false, false, -1, changeStatus, tr)()
		return nil
	})
	tr.Execute()
	...
	tr = &transactionMock{}
	tr.Add(func () error {
		getModifyHabitFunc(h, "", "", "", "", "", true, false, false, false, false, -1, changeStatus, tr)()
		return nil
	})
	tr.Execute()
	...
	tr = &transactionMock{}
	tr.Add(func () error {
		getModifyHabitFunc(h, "", resources.HBT_REPETITION_DAILY, "", tomorrowDeadlineStr, "", true, false, false, false, false, 5, changeStatus, tr)()
		return nil
	})
	tr.Execute()
	...
	tr = &transactionMock{}
	tr.Add(func () error {
		getModifyHabitFunc(h, "", "", "", "", "", false, true, false, false, false, -1, changeStatus, tr)()
		return nil
	})
	tr.Execute()
	...
	tr = &transactionMock{}
	tr.Add(func () error {
		getModifyHabitFunc(h, "", "", "", "", "", false, false, true, false, false, -1, changeStatus, tr)()
		return nil
	})
	tr.Execute()
